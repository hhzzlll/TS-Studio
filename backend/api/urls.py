...
from .views import FileUploadView, TrainingView, ConfigView, TrainingStatusView, PredictView, PredictionResultView, ActiveTrainingView, DatasetListView, DatasetInfoView
